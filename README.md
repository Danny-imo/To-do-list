...
**To Do List** is an app built on javascript and bundlers like webpack to keep track of one activities and clear them by choice
...
- [Live Demo Link](https://danny-imo.github.io/To-do-list/dist/)
...
```sh
  cd my-folder
  git clone git@github.com:Danny-imo/To-do-list.git
```
